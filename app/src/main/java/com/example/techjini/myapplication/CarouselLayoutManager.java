...
public class CarouselLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private void fillChildItem(final int start, final int top, final int end, final int bottom, @NonNull final CarouselLayoutManager.LayoutOrder layoutOrder, @NonNull final RecyclerView.Recycler recycler, final int i) {
    ...
    private void recyclerOldViews(final RecyclerView.Recycler recycler) {
        for (RecyclerView.ViewHolder viewHolder : new ArrayList<>(recycler.getScrapList())) {
            ...
            boolean found = false;
            for (CarouselLayoutManager.LayoutOrder layoutOrder : mLayoutHelper.mLayoutOrder) {
    ...
    private static class LayoutHelper {
        ...
        private CarouselLayoutManager.LayoutOrder createLayoutOrder() {
            final Iterator<WeakReference<CarouselLayoutManager.LayoutOrder>> iterator = mReusedItems.iterator();
    ...
    protected static class CarouselSavedState implements Parcelable {
        ...
        public static final Parcelable.Creator<CarouselLayoutManager.CarouselSavedState> CREATOR
            ...
            @Override
            public CarouselLayoutManager.CarouselSavedState createFromParcel(final Parcel parcel) {
                return new CarouselLayoutManager.CarouselSavedState(parcel);
            }

            @Override
            public CarouselLayoutManager.CarouselSavedState[] newArray(final int i) {
        ...
        protected CarouselSavedState(@NonNull final CarouselLayoutManager.CarouselSavedState other) {
